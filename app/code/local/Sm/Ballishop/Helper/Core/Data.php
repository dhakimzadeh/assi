...
class Sm_Ballishop_Helper_Core_Data extends Mage_Core_Helper_Data
{
    const XML_PATH_MINIFY_ENABLE_YUICOMPRESSOR  = 'ballishop_cfg/advanced/enable_yuicompressor';
	const XML_PATH_MINIFY_ENABLE                = 'ballishop_cfg/advanced/compress_css_js';
    ...
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_MINIFY_ENABLE);
    }
