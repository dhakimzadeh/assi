...
class MW_Affiliate_Block_Adminhtml_Affiliatebanner_Edit_Tab_Member extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      ...
      $collection = Mage::getModel('affiliate/affiliatebannermember')->getCollection()
        				->addFieldToFilter('banner_id',$this->getRequest()->getParam('id'));
	  if(sizeof($collection) > 0){
	        	$this->setDefaultFilter(array('in_banner_member'=>1));
	  	}
  }
  ...
  {   
  	 // $customer = Mage::getModel('customer/customer')->getCollection();
  	  ...
  	  $credit_table = $resource->getTableName('credit/creditcustomer');
  ...
  {   
  	 $this->addColumn('in_banner_member', array(
