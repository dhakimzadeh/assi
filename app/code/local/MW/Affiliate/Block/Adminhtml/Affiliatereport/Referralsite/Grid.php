 ...
 */
class MW_Affiliate_Block_Adminhtml_Affiliatereport_Referralsite_Grid extends Mage_Adminhtml_Block_Report_Grid
{
    /**
     * Sub report size
     *
    ...
    {
        parent::__construct();
        $this->setId('gridAffiliateReportReferralsite');
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getCollection()
            ->initReport('affiliate/affiliateinvitation_referralsite_collection');
        return $this;
    }
    ...
    {
    	$this->addColumn('referral_from_domain', array(
          	'header'    => Mage::helper('affiliate')->__('Affiliate Website(s)'),
          	'align'     =>'left',
          	'index'     => 'referral_from_domain',
		  	'width'     => '250px',
		  	'type'      => 'text',
      	));
