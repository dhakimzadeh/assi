<?php
class MW_Affiliate_Block_Adminhtml_Affiliatewithdrawnpending_Grid extends Mage_Adminhtml_Block_Widget_Grid
{ 
	public function __construct()
    {
        parent::__construct();
        $this->setId('affiliate_withdrawn_pending');
        $this->setSaveParametersInSession(true);
        $this->setEmptyText(Mage::helper('affiliate')->__('No Pending Withdrawals History'));
    }
    ...
    {   
        ...
        $collection = Mage::getResourceModel('affiliate/affiliatewithdrawn_collection')
        				->addFieldToFilter('status', array('eq' => MW_Affiliate_Model_Status::PENDING))
   	...
   	protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('status', array(
             ...
             'url'  => $this->getUrl('adminhtml/affiliate_affiliatewithdrawnpending/withdrawnedit', array('_current'=>true)),
             'additional' => array(
                    'visibility' => array(
                         'name' => 'status',
                         'type' => 'select',
