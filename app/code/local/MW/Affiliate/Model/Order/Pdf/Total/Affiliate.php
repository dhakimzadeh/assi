<?php
class MW_Affiliate_Model_Order_Pdf_Total_Affiliate extends Mage_Sales_Model_Order_Pdf_Total_Default
{
/**
    ...
    {
		$affiliate_order = Mage::getModel('credit/creditorder')->load($this->getOrder()->getIncrementId());
    	return $affiliate_order->getAffiliate();
    }
