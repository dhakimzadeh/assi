<?php
class MW_Affiliate_Model_Affiliateprogram extends Mage_Core_Model_Abstract
//class MW_Affiliate_Model_Affiliateprogram extends Mage_Rule_Model_Rule

{
    ...
    {
    	parent::_construct();
        $this->_init('affiliate/affiliateprogram');
...
*/
    ...
    {
        return Mage::getResourceModel('affiliate/affiliateprogram_collection');
    }
